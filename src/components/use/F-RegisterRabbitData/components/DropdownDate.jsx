import st from '../styles/RegisterRabbitData.module.css';
...
export function DropdownDate(props) {
    ...
    function phase() {
        if (Date.now() - Date.parse(date_) <= 2629800000 && Date.now() - Date.parse(date_) > 0) {
            return 1;
        } else if (Date.now() - Date.parse(date_) > 2629800000 && Date.now() - Date.parse(date_) <= 5259600000) {
            return 2;
        } else if (Date.now() - Date.parse(date_) > 5259600000 && Date.now() - Date.parse(date_) <= 7889400000) {
            return 3;
