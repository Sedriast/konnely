...
export function Register() {
    ...
    const handleSubmit = async (e) => {
        try {
            await signup(e.target.id, newuser.userName, newuser.email, newuser.password, '+57' + newuser.phone);
            swal({
            ...
            <form id='formulario'>
                <div className={st.container}>
                    ...
                    <div className={st.submit}>
                        <Buttons id_='correo' click_={handleSubmit} link_='#' text_='Crear'></Buttons>
                    </div>
                </div>
            </form>
        </>
