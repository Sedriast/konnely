    ...
    <div className={style.subPanel}>
      <form>
        <div className={style.basicDataPanel}>
          ...
          />
          <InputDate
            clName={style.birtDate}
            iden="birtDate"
            place="Fecha de nacimiento"
            handleChanche={handleChange}
          />
          <InputDate
            clName={style.desteteDate}
            iden="desteteDate"
            place="Fecha de destete"
            handleChanche={handleChange}
          />
          <ListType
            clName={style.race}
        ...
        <div className={style.addDataPanel}>
          ...
          />
          <Btn
            clName={style.subPanelB}
            text_="→"
            itemPath="/listView"
            oClick_B={handleSubmit}
          />
        </div>
      </form>
    </div>
